...
const covid19ImpactEstimator = (data) => {
  ...
  result.severeImpact.dollarsInFlight = Math.floor(result.severeImpact.infectionsByRequestedTime
    * days * data.region.avgDailyIncomeInUSD * data.region.avgDailyIncomePopulation);
